<template>
  <div class="relative px-4 sm:px-8 lg:px-12">
    <div class="max-w-2xl mx-auto lg:max-w-5xl">
      <div class="grid grid-cols-1 lg:grid-cols-3 gap-y-8 lg:gap-x-12 items-start">
        
        <!-- Intro & Bio (Left Columns) -->
        <div class="lg:col-span-2 max-w-2xl">
          ...
          <div class="flex gap-6 mt-6">
            <a class="p-1 -m-1 group" aria-label="Follow on Instagram" href="https://instagram.com/udit_29">
            ...
            <a class="p-1 -m-1 group" aria-label="Follow on GitHub" href="https://github.com/UditThakkar">
              <svg viewBox="0 0 24 24" aria-hidden="true"
                class="w-6 h-6 transition fill-zinc-400 group-hover:fill-zinc-300">
            ...
            <a class="p-1 -m-1 group" aria-label="Follow on LinkedIn" href="https://www.linkedin.com/in/udit-thacker/">
              <svg viewBox="0 0 24 24" aria-hidden="true"
                class="w-6 h-6 transition fill-zinc-400 group-hover:fill-zinc-300">
                <path
